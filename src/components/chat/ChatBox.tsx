...
const ChatBox: FC = () => {
  ...
  return (
    <div className="flex flex-col font-dynapuff max-h-[750px] h-[750px] bg-[#0d0d0f] border-r border-b border-gray-800">
      {/* Header */}
      ...
      <div 
        ...
        className="flex-1 overflow-y-auto scrollbar-hide min-h-0 max-h-[630px]"
        style={{
          scrollbarWidth: 'none', 
