...
import { Send, Smile, Users, Clock } from 'lucide-react';
    ...
    <div className="w-64 bg-[#0d0d0f] border-r border-gray-800 flex flex-col h-full">
      ...
      >
        ...
        {messages.map((message, index) => {
          ...
          return (
            <div key={message.id} className="px-4 py-2 hover:bg-gray-900/50 transition-colors">
              {/* Timestamp separator */}
              {showTimestamp && (
          ...
          <>
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                ...
                className="w-9 h-9 bg-gray-800 hover:bg-gray-700 rounded-lg flex items-center justify-center text-gray-300 transition-colors border border-gray-700"
                type="button"
                disabled={!isConnected}
              ...
              <button
                ...
                className="w-9 h-9 bg-green-600 hover:bg-green-700 disabled:bg-gray-700 disabled:cursor-not-allowed rounded-lg flex items-center justify-center text-white transition-colors"
                type="button"
