...
export const mockMultipliers = [
  { value: 5.58, label: '5.58x', timestamp: Date.now() - 600000 },
  { value: 1.24, label: '1.24x', timestamp: Date.now() - 540000 },
  { value: 2.23, label: '2.23x', timestamp: Date.now() - 480000 },
  { value: 1.33, label: '1.33x', timestamp: Date.now() - 420000 },
  { value: 1.63, label: '1.63x', timestamp: Date.now() - 360000 },
  { value: 4.29, label: '4.29x', timestamp: Date.now() - 300000 },
  { value: 30.17, label: '30.17x', timestamp: Date.now() - 240000 },
  { value: 2.15, label: '2.15x', timestamp: Date.now() - 180000 },
  { value: 3.19, label: '3.19x', timestamp: Date.now() - 120000 },
  { value: 1.23, label: '1.23x', timestamp: Date.now() - 60000 },
];
